...
/*
    ...
    adb -d shell pm grant com.thenoton.soduto android.permission.READ_LOGS;
    ...
    adb -d shell appops set com.thenoton.soduto SYSTEM_ALERT_WINDOW allow;
    # Kill the app, new permissions take effect on restart.
    adb -d shell am force-stop com.thenoton.soduto;
